...
const calculatedPayment =  parseFloat(amount.value) * calculatedInterest;
...
console.log("the interest " + interest);
console.log("the total payment " + totalPayment);
console.log("the total interest " + totalInterest);

console.log("the principal " + principal);
console.log("the calculatedInterest " + calculatedInterest);
console.log("the calculatedPayment " + calculatedPayment);
console.log("the x value " + x);
console.log("the monthly " + monthly);

// Check if value is finite

if(isFinite(monthly)){
    totalPayment.value = (principal + calculatedPayment);
    totalInterest.value = (calculatedPayment);
